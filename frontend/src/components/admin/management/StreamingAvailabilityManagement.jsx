          ...
          <tbody>
            {availabilities.map((availability) => (
              <tr key={availability.id}>
                ...
                <td>
                  <span
                    className={`badge ${getAvailabilityTypeBadgeClass(availability.availabilityType)}`}
                  >
      ...
      {availabilities.length === 0 && !loading && (
        <div className="text-center py-5">
          ...
          <h5 className="mt-3 text-muted">
            Keine Streaming-Verfügbarkeiten vorhanden
          </h5>
          <p className="text-muted">
            Fügen Sie die erste Verfügbarkeit hinzu, um zu beginnen.
          </p>
        </div>
      )}
