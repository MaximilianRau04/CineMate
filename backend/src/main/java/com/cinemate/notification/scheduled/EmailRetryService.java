...
public class EmailRetryService {
  ...
  /**
   * Retries failed email notifications Runs every hour to check for unsent notifications older than
   * 5 minutes
   */
  ...
  public void retryFailedEmails() {
    ...
    List<Notification> unsentNotifications =
        notificationRepository.findBySentFalseAndCreatedAtBefore(fiveMinutesAgo);
