...
public class EmailTemplateService {
   ...
   */
  public String createNotificationEmailTemplate(
   ...
   * @return formatted HTML email
   */
  public String createWeeklySummaryTemplate(
      String userName, int upcomingMovies, int upcomingSeries, String content) {
    return """
            <!DOCTYPE html>
            <html>
            <head>
   ...
   * @return formatted HTML email
   */
  public String createRecommendationTemplate(
      String userName,
      String title,
      String message,
      String itemId,
    ...
    String actionUrl =
        itemId != null
            ? ("movie".equals(itemType)
                ? "http://localhost:3000/movies/" + itemId
                : "http://localhost:3000/series/" + itemId)
    ...
    String posterImage =
        posterUrl != null && !posterUrl.isEmpty()
            ? "<img src=\""
                + posterUrl
                + "\" alt=\"Poster\" style=\"max-width: 200px; height: auto; border-radius: 8px; margin: 20px 0;\"/>"
            : "";
    ...
    return """
        ...
        .formatted(
            ...
            reason != null && !reason.isEmpty()
                ? "<div class=\"reason-box\"><strong>Warum diese Empfehlung?</strong><br/>"
                    + reason
                    + "</div>"
                : "",
            actionUrl,
