...
public class TmdbService {
  ...
  public ResponseEntity<MovieResponseDTO> importMovie(int tmdbId) {
    ...
    movie.setCountry(
        raw.productionCountries != null && !raw.productionCountries.isEmpty()
  ...
  public ResponseEntity<SeriesResponseDTO> importSeries(int tmdbId) {
    ...
    series.setCountry(
        raw.originCountry != null && !raw.originCountry.isEmpty()
