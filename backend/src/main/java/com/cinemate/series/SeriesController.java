...
public class SeriesController {
  ...
  public ResponseEntity<SeriesResponseDTO> createSeries(
      @Valid @RequestBody SeriesRequestDTO series) {
  ...
  public ResponseEntity<SeriesResponseDTO> updateSeries(
      @PathVariable String id, @Valid @RequestBody SeriesRequestDTO series) {
  ...
  public ResponseEntity<Season> getSeason(@PathVariable String id, @PathVariable int seasonNumber) {
  ...
  public ResponseEntity<Season> addSeason(@PathVariable String id, @RequestBody Season season) {
  ...
  public ResponseEntity<Season> updateSeason(
      @PathVariable String id, @PathVariable int seasonNumber, @RequestBody Season season) {
  ...
  public ResponseEntity<Void> deleteSeason(
      @PathVariable String id, @PathVariable int seasonNumber) {
  ...
  public ResponseEntity<Episode> getEpisode(
      @PathVariable String id, @PathVariable int seasonNumber, @PathVariable int episodeNumber) {
  ...
  public ResponseEntity<Episode> addEpisode(
      @PathVariable String id, @PathVariable int seasonNumber, @RequestBody Episode episode) {
  ...
  public ResponseEntity<ActorResponseDTO> addActorToSeries(
      @PathVariable String seriesId, @PathVariable String actorId) {
  ...
  public ResponseEntity<DirectorResponseDTO> addDirectorToSeries(
      @PathVariable String seriesId, @PathVariable String directorId) {
