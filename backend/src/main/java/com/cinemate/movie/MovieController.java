...
public class MovieController {
  ...
  public ResponseEntity<MovieResponseDTO> updateMovie(
      @PathVariable String id, @Valid @RequestBody MovieRequestDTO movie) {
  ...
  public ResponseEntity<ActorResponseDTO> addActorToMovie(
      @PathVariable String movieId, @PathVariable String actorId) {
  ...
  public ResponseEntity<DirectorResponseDTO> addDirectorToMovie(
      @PathVariable String movieId, @PathVariable String directorId) {
