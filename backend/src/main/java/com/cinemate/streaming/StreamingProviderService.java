...
public class StreamingProviderService {
  ...
  public ResponseEntity<List<StreamingProviderResponseDTO>> getAllActiveProviders() {
    ...
    List<StreamingProviderResponseDTO> response =
        providers.stream().map(StreamingProviderResponseDTO::new).collect(Collectors.toList());
  ...
  public Optional<StreamingProviderResponseDTO> getProviderById(String id) {
    return providerRepository.findById(id).map(StreamingProviderResponseDTO::new);
  }
  ...
  public ResponseEntity<StreamingProviderResponseDTO> createProvider(
      StreamingProviderRequestDTO providerDTO) {
  ...
  public ResponseEntity<StreamingProviderResponseDTO> updateProvider(
      String id, StreamingProviderRequestDTO providerDTO) {
  ...
  public int cleanupOrphanedAvailabilities() {
    ...
    List<StreamingAvailability> orphanedAvailabilities =
