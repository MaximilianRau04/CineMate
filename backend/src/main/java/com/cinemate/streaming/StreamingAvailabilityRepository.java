...
public interface StreamingAvailabilityRepository
    extends MongoRepository<StreamingAvailability, String> {

  List<StreamingAvailability> findByMediaIdAndMediaType(String mediaId, MediaType mediaType);

  List<StreamingAvailability> findByMediaIdAndMediaTypeAndRegion(
      String mediaId, MediaType mediaType, String region);
