...
public class StreamingController {
  ...
  public ResponseEntity<List<StreamingProviderResponseDTO>> getProvidersByCountry(
  ...
  public ResponseEntity<StreamingProviderResponseDTO> createProvider(
  ...
  public ResponseEntity<StreamingProviderResponseDTO> updateProvider(
      @PathVariable String id, @Valid @RequestBody StreamingProviderRequestDTO providerDTO) {
  ...
  public ResponseEntity<StreamingProviderResponseDTO> toggleProviderStatus(
  ...
  public ResponseEntity<StreamingAvailabilityResponseDTO> addAvailability(
    ...
    return availabilityService.addAvailability(
        mediaId, mediaType, providerId, availabilityType, region, price, currency, quality, url);
  }
  ...
  public ResponseEntity<Void> deleteAllAvailabilityForMedia(
      @PathVariable String mediaId, @PathVariable String mediaType) {
