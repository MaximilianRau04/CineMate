...
public class ReviewController {
  ...
  public ResponseEntity<ReviewResponseDTO> getReviewByMovieAndUser(
      @PathVariable String movieId, @PathVariable String userId) {
  ...
  public ResponseEntity<ReviewResponseDTO> getReviewBySeriesAndUser(
      @PathVariable String seriesId, @PathVariable String userId) {
  ...
  public ResponseEntity<ReviewResponseDTO> updateReview(
      @PathVariable String id, @Valid @RequestBody ReviewRequestDTO reviewRequestDTO) {
