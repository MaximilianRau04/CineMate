...
public interface ForumPostRepository extends MongoRepository<ForumPost, String> {
  ...
  Page<ForumPost> findByCategoryAndIsDeletedFalseOrderByCreatedAtDesc(
  ...
  Page<ForumPost> findByAuthorIdAndIsDeletedFalseOrderByCreatedAtDesc(
      String authorId, Pageable pageable);

  Page<ForumPost> findByMovieIdAndIsDeletedFalseOrderByCreatedAtDesc(
      String movieId, Pageable pageable);

  Page<ForumPost> findBySeriesIdAndIsDeletedFalseOrderByCreatedAtDesc(
      String seriesId, Pageable pageable);

  @Query(
      "{'$and': [{'isDeleted': false}, {'$or': [{'title': {'$regex': ?0, '$options': 'i'}}, {'content': {'$regex': ?0, '$options': 'i'}}]}]}")
  ...
  @Query(
      "{'$and': [{'isDeleted': false}, {'$or': [{'author.$id': ?0}, {'replies': {'$elemMatch': {'author.$id': ?0}}}]}]}")
  ...
  Page<ForumPost> findByMovieIdIsNullAndSeriesIdIsNullAndIsDeletedFalseOrderByCreatedAtDesc(
      Pageable pageable);

  Page<ForumPost> findByCategoryAndMovieIdIsNotNullAndIsDeletedFalseOrderByCreatedAtDesc(
      ForumCategory category, Pageable pageable);

  Page<ForumPost> findByCategoryAndSeriesIdIsNotNullAndIsDeletedFalseOrderByCreatedAtDesc(
      ForumCategory category, Pageable pageable);
